      ...
      <div className="bg-gray-900 text-white min-h-screen">
        <nav className="flex justify-between items-center p-6">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <button className="bg-blue-600 px-4 py-2 rounded mr-2">
              Sign In
            </button>
        ...
        <header className="flex flex-col-reverse md:flex-row justify-between items-center mt-16 p-6 max-w-6xl mx-auto">
          ...
          <div className="max-w-lg text-center md:text-left">
            ...
            <p className="text-gray-400 mt-4">
              Whether you are looking to advance your career, learn a new skill,
              or explore your passion, we provide expertly crafted courses in
              various fields.
            </p>
            <div className="mt-6">
